...
<body>
    ...
    require_once('include/f_vaga-entrada-check.php');
                    ...
                    <form class="" method="POST" action="include/f_vaga-entrada.php">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-2 mb-3">
                                <button type="submit" class="btn"><a class="btn btnVoltar text-uppercase fw-bold" href="vaga-mov-lista.php">Voltar</a></button>
                            </div>
                            <div class="col-md-4 mb-3">
                                <button type="submit" class="btn text-uppercase fw-bold mt-2" style="background-color: #7BB062; color: white; margin-left: 100px">Cadastrar</button>
                            </div>
                        </div>
                ...
                <div class="col-md-8 order-md-1">
                    <form class="" method="POST" action="include/f_vaga-entrada.php">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 mb-3">
                                <label for="mov_data_entrada" class="form-label text-uppercase fw-bold">Data Entrada:</label>
                                <input type="date" class="form-control" id="mov_data_entrada" name="mov_data_entrada" placeholder="" value="" required disabled>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 mb-3">
                                <label for="mov_hora_entrada" class="form-label text-uppercase fw-bold">Hora Entrada:</label>
                                <input type="time" class="form-control" id="mov_hora_entrada" name="mov_hora_entrada" placeholder="" step="2" value="" required disabled>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 mb-3">
                                <label for="mov_placa" class="form-label text-uppercase fw-bold">Placa:</label>
                                <input type="text" class="form-control" id="mov_placa" name="mov_placa" placeholder="" value="" required disabled>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                <button type="submit" class="btn text-uppercase fw-bold" style="background-color: #7BB062; color: white; margin-left: 100px" disabled>Cadastrar</button>
                            </div>
                        </div>
