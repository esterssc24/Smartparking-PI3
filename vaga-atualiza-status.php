            ...
            <div class="row justify-content-center">
                <div class="col-md-8 order-md-1">
                    <form class="" method="POST" action="include/f_vaga-status.php">
                        <h4 class="text-uppercase fw-bold rounded text-center p-2" style="background-color: #7BB062; color: white; height: 50px">Atualizar vagas</h4>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 mb-3">
                                <button type="submit" class="btn"><a class="btn btnVoltar text-uppercase fw-bold btn btn-outline-success" href="vaga-gerenciamento.php">Voltar</a></button></button>
                            </div>
                            <div class="col-md-6 mb-3">
                                <button type="submit" class="btn text-uppercase fw-bold" style="background-color: #7BB062; color: white; margin-left: 100px">Atualizar</button>
                            </div>
                        </div>
                    </form>
                </div>
