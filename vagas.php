...
<body>
    <div class="container-fluid">
        <nav class="navbar bg-body-tertiary">
            <a class="navbar-brand ms-5" href="home.php"><img src="img/logo_new.png" alt="" width="200px"></a>
            <li class="nav-item dropdown me-5">
                ...
                <div class="dropdown-menu" style="margin-top: 10px;" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item text-uppercase fw-bold" target="_blank" style="background-color: #7BB062; color: white;" href="minha-conta.php">Minha conta</a>
                    <a class="dropdown-item mt-2 text-uppercase fw-bold" style="background-color: #7BB062; color: white;" href="include/f_logout.php" target="_blank">Sair</a>
                        ...
                        <div class="row position-relative">
                            ...
                            <div class="col-md-6">
                                <a href="vaga-cadastro.php">
                                    <button type="button" class="btn position-absolute top-0 end-0 me-3 mt-2 text-uppercase fw-bold" style="background-color: #7BB062; color: white;">Cadastrar</button>
                                </a>
                            </div>
                        </div>
                    </form>
