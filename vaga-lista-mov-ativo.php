...
//print_r($lista);
//die();
/*<a href="vaga-saida.php?mov_id=<?= $linha['mov_id'] ?>">Atualizar</a>*/
?>
                ...
                <div class="card border border-success" style="width: 280px">
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            ...
                            <span class="text-muted"><?php echo date_format(date_create($linha['mov_data_saida']), '//'); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                    ...
                    <div class="mb-3">
                        <a href="vaga-saida.php?mov_id=<?= $linha['mov_id'] ?>">
                            <button type="submit" class="btn text-uppercase fw-bold" style="background-color: #7BB062; color: white;">Atualizar Ticket</button></a>
                    </div>
                </div>
            <?php endforeach ?>
